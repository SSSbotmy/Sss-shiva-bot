...
"https://i.postimg.cc/XqchvPXW/girl-photo-hd-wallpaper-hidden-face-dp-mano-name-photodoozy.jpg"
   ...
   var callback = () => api.sendMessage({body:`💝 𝐌𝐚𝐝𝐞 𝐁𝐲 𝐅𝐚𝐢𝐳 𝐚𝐧𝐬𝐚𝐫𝐢 💝 : ${link.length}`,attachment: fs.createReadStream(__dirname + "/cache/5.jpg")}, event.threadID, () => fs.unlinkSync(__dirname + "/cache/5.jpg"));	
